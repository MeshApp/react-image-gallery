...
export default class InsideNavSlider extends React.Component {
  ...
  _renderItem = (item) => {
    ...
    return (
      <div className='image-gallery-image' style={clickStyle} onClick={() => this.sliderClicked(item)}>
        ...
        {<div className='meshapp-insidenav-info-wrapper'>
          {
            item.title &&
            <div className='meshapp-inside-nav-title' style={{ color: this.props.mobileTitleColor }}>
              {item.title}
            </div>
          }
          {
            ...
            <div className="meshapp-inside-nav-description-wrapper">
              <div className='meshapp-inside-nav-description' style={{ color: this.props.mobileDescriptionColor }}>
                {item.description}
              </div>

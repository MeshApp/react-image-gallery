...
var PresentationSlider = function (_React$Component) {
  _inherits(PresentationSlider, _React$Component);

  function PresentationSlider(props) {
    _classCallCheck(this, PresentationSlider);

    var _this = _possibleConstructorReturn(this, (PresentationSlider.__proto__ || Object.getPrototypeOf(PresentationSlider)).call(this, props));
  ...
  _createClass(PresentationSlider, [{
...
exports.default = PresentationSlider;